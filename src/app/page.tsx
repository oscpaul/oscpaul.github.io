...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <Link href='/about'>
                <button className='orderbutton text-xl font-medium rounded-full text-white py-3 px-8 bg-primary hover:text-primary border border-primary hover:bg-transparent hover:cursor-pointer transition ease-in-out duration-300'>
                  Order-To-Go
                </button>
              </Link>
      </section>
